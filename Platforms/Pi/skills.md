...
CodeStream 사용자 Skill은 필요한 작업을 `/skill:ct-*`로 직접 호출한다.
...
조회·검색·저장과 변경 작업은 `/skill:ct-wiki-api <도구 작업> ?`에서 필요한 인자를 확인할 수 있다.
