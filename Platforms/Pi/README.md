...
- 제품 기능과 명령은 현재 환경과 [Pi 공식 문서](https://github.com/earendil-works/pi/tree/main/packages/coding-agent)에서 확인해요.

Pi는 모델 제공자를 직접 선택하고, 필요한 기능을 TypeScript Extension으로 만들어 붙일 수 있어요.  
